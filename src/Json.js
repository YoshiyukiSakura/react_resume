const JSON = {
    ...
    companies: {
        dasouche: {
            ...
            tech_stack: 'Vue、React Native、hybrid、webpack',
            project: [
                {
                    name: '工作台App',
                    date: '2019.03 — 2019.05',
                    detail: [
                        '用 RN 开发了工作台App，解决了混合App效率低体验差，原生App开发周期长，真机调试门槛高的问题。',
                        '完成用户中心、目标管理、用户管理三个模块，用 mobx 进行状态管理',
                ...
                },
                {
                    ...
                    detail: [
                        '弹个车App三十多人协同参与，Web端，app端，RN，服务端联动的项目。',
                        '设计稿还原度高。',
                        '与同事互相code review，提高了代码质量。'
                    ]
                },
                {
                    ...
                    detail: [
                        '独立负责Web端的架构设计，框架搭建，组件开发，业务逻辑开发。',
                        '效率敏捷，交付准时。'
                    ]
                }
            ]
        ...
        newdun: {
            ...
            project: [
                ...
                },
                {
                    ...
                    detail: [
                        '工作内容：负责网站整体框架的搭建。借助Element—UI实现前端页面与业务逻辑代码的快速编写。',
                ...
                },
                {
                    ...
                    detail: [
                        ...
                        '改进：将部分数据运算转移至前端，替代重新请求API。用@media适配三屏。',
                        ''
                    ]
                },
                { // 可以删掉，没有技术难点
        ...
        yuncheng: {
            ...
            project: [
                ...
                },
                {
                    ...
                    detail: [
                        '这是一个针对小微企业的记账软件。',
                        '相关技术：用公司框架开发的一套SPA项目，使用Ajax完成了与后端的配合，用模板引擎完成对页面的渲染。',
                        '运用继承机制解决了共同代码的复用问题。'
                    ]
                }
            ]
